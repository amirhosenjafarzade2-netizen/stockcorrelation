...
# FIXED VERSION
# Major fixes:
# - Fixed per-share vs total-value bugs
# - Fixed DCF debt handling
# - Fixed Owner Earnings model
# - Fixed EVA/APV/SOTP bugs
# - Fixed MOS logic
# - Added growth clamps
# - Safer terminal growth
# - More realistic screener outputs
