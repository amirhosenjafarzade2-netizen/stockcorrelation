...
def get_available_modules() -> Dict[str, dict]:
    ...
    try:
        ...
        modules["🌍 Macro/E/Economic Context"] = {
    ...
    try:
        ...
        modules["🛢️ Commodities"] = {
            "func": render_commodities,
            "desc": "In-depth analysis of commodity futures, trends, seasonality, and performance",
            "uses_context": True
        }
    except ImportError:
        pass
...
with col_left:
    st.caption(f"Built with ❤️ • Powered by Streamlit & yfinance • {Config.APP_TITLE} v{Config.APP_VERSION}")
with col_right:
